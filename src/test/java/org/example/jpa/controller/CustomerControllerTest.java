...
@AutoConfigureMockMvc(addFilters = false)   // addFilter = false : disables security filter for unit tests
class CustomerControllerTest {
    ...
    void setUp() {
        ...
        customer1 = Customer.builder()
                .name("Customer X")
                .email("cust_x@mail.com")
                .phone("12345678")
                .build();

        customer2 = Customer.builder()
                .name("Customer Y")
                .email("cust_y@mail.com")
                .phone("98765432")
                .build();
    ...
    void allCustomers() throws Exception{
        // 1. arrange - setup precondition
        customerRepository.saveAll(customerList);

        // 2. act - action or behaviour to test
    ...
    void updateCustomer() throws Exception{
        ...
        updateCustomer1.setEmail("updated_customer_x@mail.com");
    ...
    void deleteCustomer() throws Exception{
        ...
        resultActions.andExpect(status().isOk())
                .andDo(print())
                //check if the body response = expected message
    ...
    void countCustomer() throws Exception{
        ...
        String expectedString = objectMapper.writeValueAsString(expectedResponse);  // {total: 2}
